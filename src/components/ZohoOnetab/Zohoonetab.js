...
export const Zohoonetab = () => {
          ...
          Activities: [
            {
              ...
              Description:
                "We will be setting up your organization's name, address, contact information, and other relevant details to establish a profile in Zoho Books.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 1,
            },
            {
              ...
              Description:
                "We will set the primary currency for transactions and define the fiscal year start and end dates for accurate financial reporting within Zoho Books.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 4,
          ...
          Activities: [
            {
              ...
              Description:
                "We will be adding new users, defining roles, and modifying access levels through user profiles that include names, email addresses, and assigned permissions to control access to features.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 0.5,
          ...
          Activities: [
            {
              ...
              Description:
                "We would verify your organization’s domain in Zoho Books to enable branded email notifications and improve communication professionalism.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 6,
          ...
          Activities: [
            {
              ...
              Description:
                "Once you provide bank details, we will add your bank account information in Zoho Books to facilitate transactions and streamline bank reconciliations.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 2,
          ...
          Activities: [
            {
              ...
              Description:
                "There are 30+ default accounts under different categories like Assets, Liability, Equity, Income, and Expense available in Zoho Books. We will share the list of Chart of Accounts available by default. If you require additional accounts, we will create them to categorize all financial transactions.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 4,
          ...
          Activities: [
            {
              ...
              Description:
                "Once you provide Accounts Receivable, Accounts Payable, and other account balances, we will set initial balances for all accounts in Zoho Books.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 3,
          ...
          Activities: [
            {
              ...
              Description:
                "We will configure tax settings, including rates and rules, to ensure compliance and automate calculations within Zoho Books.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 1,
          ...
          Activities: [
            {
              ...
              Description:
                "If you require multiple branches, we will configure them in Zoho Books, including names and locations, to facilitate branch-specific financial tracking.",
              Basic: true,
              Intermediate: true,
              Advanced: true,
              EstimatedTime: 1,
          ...
          Activities: [
            {
              ...
              Description:
                "We will configure transaction series for multiple branches in Zoho Books.",
              Basic: false,
              Intermediate: false,
              Advanced: true,
              EstimatedTime: 2,
  ...
  const getFilteredTasks = () => {
    const tabToProductMap = {
      ZohoOnetab: "Zoho People",
      ZohoBookstab: "Zoho Books",
      ZohoCliqtab: "Zoho Cliq",
      ZohoSalesiqtab: "Zoho Salesiq",
      ZohoCRMtab: "Zoho CRM",
      ZohoWorkdrivetab: "Zoho Workdrive",
      ZohoMailtab: "Zoho Mail",
      ZohoProjectstab: "Zoho Projects",
      ZohoDesktab: "Zoho desk",
    };

    // const productName = tabToProductMap[activeTab];
    // return productName
    //   ? tasks.filter((task) => task.Product === productName)
    //   : tasks;
  };

  // Then in your table body, replace tasks.map with:
                    ...
                    >
                      ...
                      >
                        <div className="h-full px-4 py-3">
                          <input
                            type="checkbox"
                            className={`w-4 h-4 cursor-default border-white ${
                              activePlan === "Basic" && activity.Basic
                      ...
                      >
                        <div className="h-full px-4 py-3">
                          <input
                            type="checkbox"
                            className={`w-4 h-4 cursor-default border-white ${
                              activePlan === "Advanced" && activity.Advanced
                                ? "accent-green-600 border"
                                : "accent-green-600"
                            }`}
            ...
            <tfoot className="sticky bottom-0 bg-gray-100 z-10">
              <tr className="text-center">
                ...
                {["Basic", "Intermediate", "Advanced", "Custom"].map((plan) => (
                  <td
                    key={plan}
                    className={`cursor-pointer transition px-4 py-3 font-bold rounded ${
                      activePlan === plan
